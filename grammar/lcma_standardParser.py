...
class lcma_standardGrammar(Grammar):
    ...
    FormalType = Alternative(Text('hybrid1'), Text('hyb1'), Text('hybrid2'), Text('hyb2'), Text('hybrid3'), Text('hyb3'), Text('hybrid4'), Text('hyb4'), Text('period'), Text('pd'), Series(Text('repeated'), Option(Text('_')), wsp__, Unit), Text('ritornello form'), Text('ritornello'), Text('rondo form'), Text('rondo'), Text('sentence'), Text('sent'), Text('sequence'), Text('seq'), Text('sonata form'), Text('sonata'), Text('unary form'), Text('unary'), Text('simple_binary.balanced'), Text('simple_binary'), Text('rounded_binary'), Text('ternary.through_composed'), Text('ternary.da_capo'), Text('ternary'))
